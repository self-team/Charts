...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    @objc open var isScaleXEnabled: Bool { scaleXEnabled }
    @objc open var isScaleYEnabled: Bool { scaleYEnabled }

    /// flag that indicates if double tap zoom is enabled or not
    @objc open var doubleTapToZoomEnabled: Bool {
        get {
            _doubleTapToZoomEnabled
        }
        set {
    ...
    @objc open var isFullyZoomedOut: Bool { _viewPortHandler.isFullyZoomedOut }
    ...
    @objc open var isPinchZoomEnabled: Bool { pinchZoomEnabled }
    ...
    @objc open var hasNoDragOffset: Bool { _viewPortHandler.hasNoDragOffset }
    ...
    @objc open var autoScaleMinMaxEnabled: Bool {
        get { _autoScaleMinMaxEnabled }
        set { _autoScaleMinMaxEnabled = newValue }
    }

    /// **default**: false
    /// `true` if auto scaling on the y axis is enabled.
    @objc open var isAutoScaleMinMaxEnabled: Bool { autoScaleMinMaxEnabled }
